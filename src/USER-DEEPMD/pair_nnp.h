...
#define GIT_SUMM v1.1.4-210-gbc01883
#define GIT_HASH bc01883
#define GIT_BRANCH HEAD
#define GIT_DATE 2020-05-23 23:34:57 +0800
#ifdef HIGH_PREC
#define FLOAT_PREC double
#else
#define FLOAT_PREC float
#endif
#define DEEPMD_ROOT /home/pint/soft/anaconda3/envs/deepmd-1.2.0
#define TensorFlow_INCLUDE_DIRS /home/pint/soft/anaconda3/envs/deepmd-1.2.0/include;/home/pint/soft/anaconda3/envs/deepmd-1.2.0/include
#define TensorFlow_LIBRARY /home/pint/soft/anaconda3/envs/deepmd-1.2.0/lib/libtensorflow_cc.so;/home/pint/soft/anaconda3/envs/deepmd-1.2.0/lib/libtensorflow_framework.so
...
private:  
  ...
  int *ilist_short;                   // # of J neighbors for each I atom
  int *ilist_label_reverse;                   // # of J neighbors for each I atom
  int ndeepmd_region, n_label_reverse, maxatom, ago_deepmd, ago_halfdeepmd;
  int ssa;
  int **firstneigh_new, *numneigh_new;
};
